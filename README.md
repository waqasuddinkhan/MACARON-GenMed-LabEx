...
```
In this case, our big BAM file `sample02.bam` (not provided here, obviously!!!) is subsetted as `sub1.chr22_21349676-21349677.sample02.bam` (see [demo] folder) for the position `chr22:21349676`. The `sub1.bed` file is:
